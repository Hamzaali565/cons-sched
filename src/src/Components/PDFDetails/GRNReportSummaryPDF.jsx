...
const GRNReportSummaryPDF = ({ resultData, category }) => {
          ...
          <View key={index} style={styles.itemContainer}>
            <View style={styles.tableRow}>
              ...
              <Text
                style={[
                  styles.tableCell,
                  { width: "25%", borderRight: "1px solid black" },
                ]}
              >
                {item?.amount}
              </Text>
...
const SubHeader = ({ category }) => {
  return (
    ...
    >
      {`Summary Report of Item Purchases`}
    </Text>
  );
};
    ...
    <View style={[styles.itemContainer]}>
      ...
      >
        ...
        <Text
          style={[
            styles.tableCell,
            { width: "25%", borderTop: "1px solid black" },
          ]}
        >
...
export default GRNReportSummaryPDF;
